...
mv otutable_notax_$REFDATABASE.sorted.txt otutable_notax.txt
...
if [[ "$1" =~ ^(-help|-h)$ ]]
	...
	if [ $TAX -lt 1 ] || [ $TAX -gt 4 ]
        ...
        echoWithDate "Output files of the OTU/ZOTU taxonomy assignment: $FILERAD.sintax.$TAXFILE.txt, ${TABFILERAD}_${TAXFILE}.txt"
        #date
        echoPlus ""
        exit 0
...
echoPlus ""
echoPlus "Do you want to process single-end reads or paired-end reads? (yes/no/both)"
...
# Define amplicon region = V13/V4/ITS (AMPREGION)
echoPlus ""
echoPlus "What genomic region does your PCR amplicons amplify? (V13/V4/ITS)"
...
echoPlus "        2  - MiDAS v3.0 (2019-01-09)"
