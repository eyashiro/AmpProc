...
$SCRIPTPATH/ASVpipeline.sh $REFDATAPATH
...
# Run Midas workflow if selected
   if [ $WORKFLOW = "M" ]
    ...
    echoPlus "        1  - MiDAS v3.3 (2019-09-19)"
    echoPlus "        2  - MiDAS v4.2 (2019-09-19)" 
    echoPlus ""
...
echoPlus "        3  - MiDAS v3.3 (2019-09-19)"
echoPlus "        4  - MiDAS v4.2 (2019-09-19)"
